...
| `metric` | string | metric used to compare models | regression: `MAPE` (default), `RMSE`, `R^2`, `MAE`, `MSE`, `QL`; classification: `F1` (default), `Accuracy`, `Precision`, `Recall`, `BalancedAccuracy` |
