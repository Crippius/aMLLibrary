...
import model_building.xgboost_experiment_configuration as xgb_reg


class XGBoostClassifierExperimentConfiguration(ec.ExperimentConfiguration):
    """
    Class representing a single experiment configuration for XGBoost classification
    ...
    _train()
        Performs the actual building of the XGBoost model
    ...
    def __init__(self, campaign_configuration, hyperparameters, regression_inputs, prefix):
        ...
        self.technique = ec.Technique.XGBOOST_CLASSIFIER
    ...
    def _train(self):
        ...
        weights = xgb_reg.XGBoostExperimentConfiguration.get_weights_dict(self._regressor)
    ...
    def compute_estimations(self, rows):
        ...
        Returns
        -------
            The class labels predicted by the associated regressor
        """
    ...
    def initialize_regressor(self):
        ...
        if not getattr(self, '_hyperparameters', None):
            self._regressor = xgb.XGBClassifier()
        else:
            ...
            if self._disable_model_parallelism:
                ...
                self._regressor = xgb.XGBClassifier(**pars)
